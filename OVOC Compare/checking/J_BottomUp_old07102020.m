function J = J_BottomUp_New(LFlux,T,P,J2plot)
...
i=i+1;
Jnames{i} = 'Jn7'; %CH3COCH3 -> MCO3 + MO2
CS{i} =@Cross_Section_Aceta;
QY{i} = 1;
...
%Newly added from Geos-Chem

i = i + 1;
Jnames{i} = 'Jn57';
CS{i} = @Cross_Section_O2;%O2-->2O
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn58';
CS{i} = @Cross_Section_NO;%NO-->N+O
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn59';
CS{i} = @Cross_Section_ClNO3a;%ClNO3-->Cl+NO3
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn60';
CS{i} = @Cross_Section_ClNO3b;%ClNO3-->ClO+NO2
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn61';
CS{i} = @Cross_Section_OCS;%OCS-->SO2+CO
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn62';
CS{i} = @Cross_Section_N2O;%N2O-->N2+O
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn63';
CS{i} = @Cross_Section_CFCl3;%CFC11-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn64';
CS{i} = @Cross_Section_CF2Cl2;%CFC12-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn65';
CS{i} = @Cross_Section_F113;%CFC113-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn66';
CS{i} = @Cross_Section_F114;%CFC114-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn67';
CS{i} = @Cross_Section_F115;%CFC115-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn68';
CS{i} = @Cross_Section_CCl4;%CCl4-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn69';
CS{i} = @Cross_Section_CH3Cl;%CH3Cl-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn70';
CS{i} = @Cross_Section_MeCCl3;%CH3CCl3-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn71';
CS{i} = @Cross_Section_CH2Cl2;%CH2Cl2-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn72';
CS{i} = @Cross_Section_CHF2Cl;%HCFC22-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn73';
CS{i} = @Cross_Section_F123;%HCFC123-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn74';
CS{i} = @Cross_Section_F141b;%HCFC141b-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn75';
CS{i} = @Cross_Section_F142b;%HCFC142b-->Cl + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn76';
CS{i} = @Cross_Section_CH3Br;%CH3Br-->Br + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn77';
CS{i} = @Cross_Section_H1211;%H1211-->Br + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn78';
CS{i} = @Cross_Section_H1301;%H1301-->Br + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn79';
CS{i} = @Cross_Section_H2402;%H1301-->Br + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn80';
CS{i} = @Cross_Section_CH2Br2;%CH2B-->Br + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn81';
CS{i} = @Cross_Section_CF3I;%CF3I-->I + PRODUCT
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn82';
CS{i} = @Cross_Section_MeVK;%MVK-->PRPE + CO
QY{i} = 0.6; %No recommendation

i = i + 1;
Jnames{i} = 'Jn83';
CS{i} = @Cross_Section_MeVK;%MVK-->MCO3+CH2O+CO+HO2
QY{i} = 0.2; %No recommendation

i = i + 1;
Jnames{i} = 'Jn84';
CS{i} = @Cross_Section_MeVK;%MVK-->MO2+RCO3
QY{i} = 0.2; %No recommendation

i = i + 1;
Jnames{i} = 'Jn85';
CS{i} = @Cross_Section_MeAcr;%MACR-->CO+HO2+CH2O+MCO3
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn86';
CS{i} = @Cross_Section_PrAld;%RCHO-->EtO2+HO2+CO;GLYX-->HO2+MCO3+CO
QY{i} = 1; %No recommendation

% i = i + 1;
% Jnames{i} = 'Jn87';
% CS{i} = @Cross_Section_Aceta;%RCHO-->EtO2+HO2+CO;GLYX-->HO2+MCO3+CO
% QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn88';
CS{i} = @Cross_Section_ONIT2;%IDN-->MVK+MACR+CH2O+NO2
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn89';
CS{i} = @Cross_Section_HMHP;%HMHP-->2OH+CH2O
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn90';
CS{i} = @Cross_Section_PrAldP;%HPETHNL-->OH+CO+HO2+CH2O
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn91';
CS{i} = @Cross_Section_MGlyxl;%PYAC-->MCO3+CO2+HO2;MVKHC-->CO+HO
QY{i} = 1; %No recommendation

% i = i + 1;
% Jnames{i} = 'Jn92';
% CS{i} = @Cross_Section_PrAldP;%MCRHP-->OH+CO+MGLY+HO2+GLYX;MACR1OOH-->OH+CO+2MO2+CH2O+MCO3+MACR1OOH
% QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn93';
CS{i} = @Cross_Section_H2SO4;%SO4-->SO2+2OH
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn94';
CS{i} = @Cross_Section_ENOL;%SO4-->SO2+2OH
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn95';
CS{i} = @Cross_Section_ICN;%ICN-->NO2+CO+OH+HO2+IDC+MVKPC...
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn96';
CS{i} = @Cross_Section_MACRNP;%MCRHNB-->PORPN+N+OH+CO+HO2
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn97';
CS{i} = @Cross_Section_I2;%I2-->2I
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn98';
CS{i} = @Cross_Section_HOI;%HOI-->I+HO
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn99';
CS{i} = @Cross_Section_CH3I;%CH3I-->I+PRO
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn100';
CS{i} = @Cross_Section_CH2I2;%CH2I2-->2I+PRO
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn101';
CS{i} = @Cross_Section_CH2ICl;%CH2ICl-->I+Cl+PRO
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn102';
CS{i} = @Cross_Section_CH2IBr;%CH2ICl-->I+Br+PRO
QY{i} = 1; %No recommendation
...
i = i + 1;
Jnames{i} = 'Jn107';
CS{i} = @Cross_Section_MENO3;%MENO3-->NO2+HO2+HCHO
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn108';
CS{i} = @Cross_Section_ETNO3;%ETNO3-->NO2+HO2+ALD2
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn109';
CS{i} = @Cross_Section_IPRNO3;%IPRNO3-->NO2+HO2+ACET
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn110';
CS{i} = @Cross_Section_NPRNO3;%NPRNO3-->NO2+HO2+RCHO
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn111';
CS{i} = @Cross_Section_NITP;%INPB-->NO2+CH2O+MVK+MACR+OH+HO2
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn112';
CS{i} = @Cross_Section_HP2;%IDHDP-->OH+GLYC+HAC+ICPDH+HO2
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn113';
CS{i} = @Cross_Section_HPALD1;%HPALD1-->CO+OH+HO2+IDC+MVKPC+MCRENOL..
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn114';
CS{i} = @Cross_Section_HPALD2;%HPALD2-->CO+OH+HO2+IDC+MVKPC+MCRENOL..
QY{i} = 1; %No recommendation

i = i + 1;
Jnames{i} = 'Jn115';
CS{i} = @Cross_Section_Ones;%For reaction with J-value of 1
QY{i} = 1; %No recommendation
